...
\pins[0].oserdese2_master\: unisim.vcomponents.OSERDESE2
    generic map(
      ...
      D5 => data_out_from_device(32),
      D6 => data_out_from_device(40),
      D7 => data_out_from_device(48),
      D8 => data_out_from_device(56),
      OCE => '1',
...
\pins[1].oserdese2_master\: unisim.vcomponents.OSERDESE2
    generic map(
      ...
      D5 => data_out_from_device(33),
      D6 => data_out_from_device(41),
      D7 => data_out_from_device(49),
      D8 => data_out_from_device(57),
      OCE => '1',
...
\pins[2].oserdese2_master\: unisim.vcomponents.OSERDESE2
    generic map(
      ...
      D5 => data_out_from_device(34),
      D6 => data_out_from_device(42),
      D7 => data_out_from_device(50),
      D8 => data_out_from_device(58),
      OCE => '1',
...
\pins[3].oserdese2_master\: unisim.vcomponents.OSERDESE2
    generic map(
      ...
      D5 => data_out_from_device(35),
      D6 => data_out_from_device(43),
      D7 => data_out_from_device(51),
      D8 => data_out_from_device(59),
      OCE => '1',
...
\pins[4].oserdese2_master\: unisim.vcomponents.OSERDESE2
    generic map(
      ...
      D5 => data_out_from_device(36),
      D6 => data_out_from_device(44),
      D7 => data_out_from_device(52),
      D8 => data_out_from_device(60),
      OCE => '1',
...
\pins[5].oserdese2_master\: unisim.vcomponents.OSERDESE2
    generic map(
      ...
      D5 => data_out_from_device(37),
      D6 => data_out_from_device(45),
      D7 => data_out_from_device(53),
      D8 => data_out_from_device(61),
      OCE => '1',
...
\pins[6].oserdese2_master\: unisim.vcomponents.OSERDESE2
    generic map(
      ...
      D5 => data_out_from_device(38),
      D6 => data_out_from_device(46),
      D7 => data_out_from_device(54),
      D8 => data_out_from_device(62),
      OCE => '1',
...
\pins[7].oserdese2_master\: unisim.vcomponents.OSERDESE2
    generic map(
      ...
      D5 => data_out_from_device(39),
      D6 => data_out_from_device(47),
      D7 => data_out_from_device(55),
      D8 => data_out_from_device(63),
      OCE => '1',
...
entity selectio_wiz_dac is
  ...
  attribute NotValidForBitStream of selectio_wiz_dac : entity is true;
  attribute DEV_W : integer;
  attribute DEV_W of selectio_wiz_dac : entity is 64;
  attribute SYS_W : integer;
  attribute SYS_W of selectio_wiz_dac : entity is 8;
end selectio_wiz_dac;

architecture STRUCTURE of selectio_wiz_dac is
...
inst: entity work.selectio_wiz_dac_selectio_wiz_dac_selectio_wiz
     port map (
      ...
      clk_in => clk_in,
      data_out_from_device(63 downto 0) => data_out_from_device(63 downto 0),
