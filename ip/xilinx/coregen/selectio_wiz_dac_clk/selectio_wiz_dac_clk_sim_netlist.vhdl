...
-- Date        : Tue Jul 25 09:45:32 2023
-- Host        : PC-PAUL running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top selectio_wiz_dac_clk -prefix
--               selectio_wiz_dac_clk_ selectio_wiz_dac_clk_sim_netlist.vhdl
-- Design      : selectio_wiz_dac_clk
...
entity selectio_wiz_dac_clk_selectio_wiz_dac_clk_selectio_wiz is
  port (
  ...
  attribute DEV_W of selectio_wiz_dac_clk_selectio_wiz_dac_clk_selectio_wiz : entity is 8;
  attribute SYS_W : integer;
  attribute SYS_W of selectio_wiz_dac_clk_selectio_wiz_dac_clk_selectio_wiz : entity is 1;
  attribute num_serial_bits : integer;
  attribute num_serial_bits of selectio_wiz_dac_clk_selectio_wiz_dac_clk_selectio_wiz : entity is 8;
end selectio_wiz_dac_clk_selectio_wiz_dac_clk_selectio_wiz;

architecture STRUCTURE of selectio_wiz_dac_clk_selectio_wiz_dac_clk_selectio_wiz is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity selectio_wiz_dac_clk is
  port (
    data_out_from_device : in STD_LOGIC_VECTOR ( 7 downto 0 );
    data_out_to_pins_p : out STD_LOGIC_VECTOR ( 0 to 0 );
    data_out_to_pins_n : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of selectio_wiz_dac_clk : entity is true;
  attribute DEV_W : integer;
  attribute DEV_W of selectio_wiz_dac_clk : entity is 8;
  attribute SYS_W : integer;
  attribute SYS_W of selectio_wiz_dac_clk : entity is 1;
end selectio_wiz_dac_clk;

architecture STRUCTURE of selectio_wiz_dac_clk is
  attribute DEV_W of inst : label is 8;
  attribute SYS_W of inst : label is 1;
  attribute num_serial_bits : integer;
  attribute num_serial_bits of inst : label is 8;
begin
inst: entity work.selectio_wiz_dac_clk_selectio_wiz_dac_clk_selectio_wiz
     port map (
