...
-- Date        : Tue Jul 25 09:47:42 2023
-- Host        : PC-PAUL running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top selectio_wiz_sync -prefix
--               selectio_wiz_sync_ selectio_wiz_sync_sim_netlist.vhdl
...
entity selectio_wiz_sync_selectio_wiz_sync_selectio_wiz is
  port (
  ...
  attribute DEV_W of selectio_wiz_sync_selectio_wiz_sync_selectio_wiz : entity is 1;
  attribute SYS_W : integer;
  attribute SYS_W of selectio_wiz_sync_selectio_wiz_sync_selectio_wiz : entity is 1;
end selectio_wiz_sync_selectio_wiz_sync_selectio_wiz;

architecture STRUCTURE of selectio_wiz_sync_selectio_wiz_sync_selectio_wiz is
...
begin
inst: entity work.selectio_wiz_sync_selectio_wiz_sync_selectio_wiz
     port map (
      clk_in => clk_in,
      clk_reset => clk_reset,
