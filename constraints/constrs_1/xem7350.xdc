...
set_property IOSTANDARD LVDS [get_ports {i_da10_p}] # CHA_10_P
# FMC-C11 
set_property PACKAGE_PIN B19 [get_ports {i_da10_n}] # CHA_10_N
set_property IOSTANDARD LVDS [get_ports {i_da10_n}] # CHA_10_N
# FMC-C12 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-C13 
...
set_property IOSTANDARD LVDS [get_ports {i_db4_p}] # CHB_04_P
# FMC-C15 
set_property PACKAGE_PIN A17 [get_ports {i_db4_n}] # CHB_04_N
set_property IOSTANDARD LVDS [get_ports {i_db4_n}] # CHB_04_N
# FMC-C16 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-C17 
...
set_property IOSTANDARD LVDS [get_ports {i_db12_p}] # CHB_12_P
# FMC-C19 
set_property PACKAGE_PIN G16 [get_ports {i_db12_n}] # CHB_12_N
set_property IOSTANDARD LVDS [get_ports {i_db12_n}] # CHB_12_N
# FMC-C2 
...
set_property IOSTANDARD LVDS [get_ports {i_db6_p}] # DAC_D6_P
# FMC-C23 
set_property PACKAGE_PIN E17 [get_ports {i_db6_n}] # DAC_D6_N
set_property IOSTANDARD LVDS [get_ports {i_db6_n}] # DAC_D6_N
# FMC-C24 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-C25 
...
set_property IOSTANDARD LVDS [get_ports {i_da8_p}] # CHA_08_P
# FMC-D12 
set_property PACKAGE_PIN C18 [get_ports {i_da8_n}] # CHA_08_N
set_property IOSTANDARD LVDS [get_ports {i_da8_n}] # CHA_08_N
# FMC-D13 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-D14 
set_property PACKAGE_PIN L19 [get_ports {i_db2_p}] # CHB_02_P
set_property IOSTANDARD LVDS [get_ports {i_db2_p}] # CHB_02_P
# FMC-D15 
set_property PACKAGE_PIN L20 [get_ports {i_db2_n}] # CHB_02_N
set_property IOSTANDARD LVDS [get_ports {i_db2_n}] # CHB_02_N
# FMC-D16 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-D17 
set_property PACKAGE_PIN E15 [get_ports {i_db10_p}] # CHB_10_P
set_property IOSTANDARD LVDS [get_ports {i_db10_p}] # CHB_10_P
# FMC-D18 
set_property PACKAGE_PIN E16 [get_ports {i_db10_n}] # CHB_10_N
set_property IOSTANDARD LVDS [get_ports {i_db10_n}] # CHB_10_N
# FMC-D19 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-D2 
...
set_property IOSTANDARD LVDS [get_ports {o_dac7_p}] # DAC_D7_P
# FMC-D21 
set_property PACKAGE_PIN D10 [get_ports {o_dac7_n}] # DAC_D7_N
set_property IOSTANDARD LVDS [get_ports {o_dac7_n}] # DAC_D7_N
# FMC-D22 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-D23 
set_property PACKAGE_PIN F14 [get_ports {o_dac3_p}] # DAC_D3_P
set_property IOSTANDARD LVDS [get_ports {o_dac3_p}] # DAC_D3_P
# FMC-D24 
set_property PACKAGE_PIN F13 [get_ports {o_dac3_n}] # DAC_D3_N
set_property IOSTANDARD LVDS [get_ports {o_dac3_n}] # DAC_D3_N
# FMC-D25 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-D26 
set_property PACKAGE_PIN C9 [get_ports {o_dac0_p}] # DAC_D0_P
set_property IOSTANDARD LVDS [get_ports {o_dac0_p}] # DAC_D0_P
# FMC-D27 
set_property PACKAGE_PIN B9 [get_ports {o_dac0_n}] # DAC_D0_N
set_property IOSTANDARD LVDS [get_ports {o_dac0_n}] # DAC_D0_N
# FMC-D28 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-D29 
...
set_property IOSTANDARD LVDS [get_ports {i_da0_p}] # CHA_00_P
# FMC-D9 
set_property PACKAGE_PIN F18 [get_ports {i_da0_n}] # CHA_00_N
set_property IOSTANDARD LVDS [get_ports {i_da0_n}] # CHA_00_N
# FMC-E1 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-E10 
...
set_property IOSTANDARD LVDS [get_ports {i_da4_n}] # CHA_04_N
# FMC-G11 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-G12 
set_property PACKAGE_PIN F19 [get_ports {i_db0_p}] # CHB_00_P
set_property IOSTANDARD LVDS [get_ports {i_db0_p}] # CHB_00_P
# FMC-G13 
set_property PACKAGE_PIN E20 [get_ports {i_db0_n}] # CHB_00_N
set_property IOSTANDARD LVDS [get_ports {i_db0_n}] # CHB_00_N
# FMC-G14 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-G15 
set_property PACKAGE_PIN H19 [get_ports {i_db8_p}] # CHB_08_P
set_property IOSTANDARD LVDS [get_ports {i_db8_p}] # CHB_08_P
# FMC-G16 
set_property PACKAGE_PIN G20 [get_ports {i_db8_n}] # CHB_08_N
set_property IOSTANDARD LVDS [get_ports {i_db8_n}] # CHB_08_N
# FMC-G17 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-G18 
...
set_property IOSTANDARD LVDS [get_ports {o_dac4_p}] # DAC_D4_P
# FMC-G22 
set_property PACKAGE_PIN K18 [get_ports {o_dac4_n}] # DAC_D4_N
set_property IOSTANDARD LVDS [get_ports {o_dac4_n}] # DAC_D4_N
# FMC-G23 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-G24 
set_property PACKAGE_PIN G11 [get_ports {o_dac_frame_p}] # FRAME_P
set_property IOSTANDARD LVDS [get_ports {o_dac_frame_p}] # FRAME_P
# FMC-G25 
set_property PACKAGE_PIN F10 [get_ports {o_dac_frame_n}] # FRAME_N
set_property IOSTANDARD LVDS [get_ports {o_dac_frame_n}] # FRAME_N
# FMC-G26 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-G27 
set_property PACKAGE_PIN J15 [get_ports {o_dac1_p}] # DAC_D1_P
set_property IOSTANDARD LVDS [get_ports {o_dac1_p}] # DAC_D1_P
# FMC-G28 
set_property PACKAGE_PIN J16 [get_ports {o_dac1_n}] # DAC_D1_N
set_property IOSTANDARD LVDS [get_ports {o_dac1_n}] # DAC_D1_N
# FMC-G29 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-G3 
...
set_property IOSTANDARD LVDS [get_ports {i_adc_clk_p}] # CLK_AB_P
# FMC-G7 
set_property PACKAGE_PIN H18 [get_ports {i_adc_clk_n}] # CLK_AB_N
set_property IOSTANDARD LVDS [get_ports {i_adc_clk_n}] # CLK_AB_N
# FMC-G8 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-G9 
set_property PACKAGE_PIN A18 [get_ports {i_da4_p}] # CHA_04_P
set_property IOSTANDARD LVDS [get_ports {i_da4_p}] # CHA_04_P
# FMC-H1 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-H10 
set_property PACKAGE_PIN D19 [get_ports {i_da6_p}] # CHA_06_P
set_property IOSTANDARD LVDS [get_ports {i_da6_p}] # CHA_06_P
# FMC-H11 
set_property PACKAGE_PIN D20 [get_ports {i_da6_n}] # CHA_06_N
set_property IOSTANDARD LVDS [get_ports {i_da6_n}] # CHA_06_N
# FMC-H12 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-H13 
set_property PACKAGE_PIN J18 [get_ports {i_da12_p}] # CHA_12_P
set_property IOSTANDARD LVDS [get_ports {i_da12_p}] # CHA_12_P
# FMC-H14 
set_property PACKAGE_PIN J19 [get_ports {i_da12_n}] # CHA_12_N
set_property IOSTANDARD LVDS [get_ports {i_da12_n}] # CHA_12_N
# FMC-H15 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-H16 
set_property PACKAGE_PIN C16 [get_ports {i_db6_p}] # CHB_06_P
set_property IOSTANDARD LVDS [get_ports {i_db6_p}] # CHB_06_P
# FMC-H17 
set_property PACKAGE_PIN B16 [get_ports {i_db6_n}] # CHB_06_N
set_property IOSTANDARD LVDS [get_ports {i_db6_n}] # CHB_06_N
# FMC-H18 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-H19 
...
set_property IOSTANDARD LVDS [get_ports {o_dac5_p}] # DAC_D5_P
# FMC-H23 
set_property PACKAGE_PIN L18 [get_ports {o_dac5_n}] # DAC_D5_N
set_property IOSTANDARD LVDS [get_ports {o_dac5_n}] # DAC_D5_N
# FMC-H24 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-H25 
set_property PACKAGE_PIN G15 [get_ports {o_dac_clk_p}] # DAC_DCLK_P
set_property IOSTANDARD LVDS [get_ports {o_dac_clk_p}] # DAC_DCLK_P
# FMC-H26 
set_property PACKAGE_PIN F15 [get_ports {o_dac_clk_n}] # DAC_DCLK_N
set_property IOSTANDARD LVDS [get_ports {o_dac_clk_n}] # DAC_DCLK_N
# FMC-H27 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-H28 
set_property PACKAGE_PIN H14 [get_ports {o_dac2_p}] # DAC_D2_P
set_property IOSTANDARD LVDS [get_ports {o_dac2_p}] # DAC_D2_P
# FMC-H29 
set_property PACKAGE_PIN G14 [get_ports {o_dac2_n}] # DAC_D2_N
set_property IOSTANDARD LVDS [get_ports {o_dac2_n}] # DAC_D2_N
# FMC-H3 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-H30 
...
set_property IOSTANDARD LVDS [get_ports {i_da2_p}] # CHA_02_P
# FMC-H8 
set_property PACKAGE_PIN F20 [get_ports {i_da2_n}] # CHA_02_N
set_property IOSTANDARD LVDS [get_ports {i_da2_n}] # CHA_02_N
# FMC-H9 
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# FMC-J1 
