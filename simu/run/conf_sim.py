...
if __name__ == '__main__':
    ...
    json_test_dic["tb_tes_top_test_variant_debug04"] = [solo_test_dic['tb_tes_top_test_variant_debug04']]
    json_test_dic["tb_tes_top_test_variant_debug05"] = [solo_test_dic['tb_tes_top_test_variant_debug05']]
    json_test_dic["tb_tes_top_test_variant_debug06"] = [solo_test_dic['tb_tes_top_test_variant_debug06']]
    json_test_dic["tb_tes_top_test_variant_debug07"] = [solo_test_dic['tb_tes_top_test_variant_debug07']]
    json_test_dic["tb_tes_top_test_variant_debug08"] = [solo_test_dic['tb_tes_top_test_variant_debug08']]
    json_test_dic["tb_tes_top_test_variant_debug09"] = [solo_test_dic['tb_tes_top_test_variant_debug09']]
    json_test_dic["tb_tes_top_test_variant_debug10"] = [solo_test_dic['tb_tes_top_test_variant_debug10']]
    json_test_dic["tb_tes_top_test_variant_debug11"] = [solo_test_dic['tb_tes_top_test_variant_debug11']]
    json_test_dic["tb_tes_top_test_variant_debug_all"] = [solo_test_dic['tb_tes_top_test_variant_debug_all']]
    # functional tests
    ...
    json_test_dic["tb_tes_top_test_variant_func_all"] = [solo_test_dic['tb_tes_top_test_variant_func_all']]

    # mux_squid_top
    # debug tests
    json_test_dic["tb_mux_squid_top_test_variant_debug00"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug00']]
    json_test_dic["tb_mux_squid_top_test_variant_debug01"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug01']]
    json_test_dic["tb_mux_squid_top_test_variant_debug02"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug02']]
    json_test_dic["tb_mux_squid_top_test_variant_debug03"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug03']]
    json_test_dic["tb_mux_squid_top_test_variant_debug04"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug04']]
    json_test_dic["tb_mux_squid_top_test_variant_debug05"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug05']]
    json_test_dic["tb_mux_squid_top_test_variant_debug06"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug06']]
    json_test_dic["tb_mux_squid_top_test_variant_debug07"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug07']]
    json_test_dic["tb_mux_squid_top_test_variant_debug08"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug08']]
    json_test_dic["tb_mux_squid_top_test_variant_debug09"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug09']]
    json_test_dic["tb_mux_squid_top_test_variant_debug10"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug10']]
    json_test_dic["tb_mux_squid_top_test_variant_debug11"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug11']]
    json_test_dic["tb_mux_squid_top_test_variant_debug_all"] = [solo_test_dic['tb_mux_squid_top_test_variant_debug_all']]
    # functional tests
    ...
    json_test_dic["tb_mux_squid_top_test_variant_func_all"] = [solo_test_dic['tb_mux_squid_top_test_variant_func_all']]
