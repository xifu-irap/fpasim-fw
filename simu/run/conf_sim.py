...
if __name__ == '__main__':
    ...
    unit_test_name = 'tb_system_fpasim_top'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_system_fpasim_top_test_variant00'
    # name of the testbench entity
    tb_name = 'tb_system_fpasim_top'
    # name of the testbench file
    tb_filename = 'tb_system_fpasim_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_system_fpasim_top_test_variant00.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_system_fpasim_top_test_variant01'
    # name of the testbench entity
    tb_name = 'tb_system_fpasim_top'
    # name of the testbench file
    tb_filename = 'tb_system_fpasim_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_system_fpasim_top_test_variant01.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    # name of the unitary test
    # name of the unitary test
    unit_test_name = 'tb_system_fpasim_top_test_variant02'
    # name of the testbench entity
    tb_name = 'tb_system_fpasim_top'
    # name of the testbench file
    tb_filename = 'tb_system_fpasim_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_system_fpasim_top_test_variant02.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_tes_top_test_variant00'
    # name of the testbench entity
    tb_name = 'tb_tes_top'
    # name of the testbench file
    ...
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_tes_top_test_variant00.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_tes_top_test_variant01'
    # name of the testbench entity
    tb_name = 'tb_tes_top'
    # name of the testbench file
    tb_filename = 'tb_tes_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_tes_top_test_variant01.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_tes_top_test_variant02'
    # name of the testbench entity
    tb_name = 'tb_tes_top'
    # name of the testbench file
    tb_filename = 'tb_tes_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_tes_top_test_variant02.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_tes_top_test_variant03'
    # name of the testbench entity
    tb_name = 'tb_tes_top'
    # name of the testbench file
    tb_filename = 'tb_tes_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_tes_top_test_variant03.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_tes_top_test_variant04'
    # name of the testbench entity
    tb_name = 'tb_tes_top'
    # name of the testbench file
    tb_filename = 'tb_tes_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_tes_top_test_variant04.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_tes_top_test_variant05'
    # name of the testbench entity
    tb_name = 'tb_tes_top'
    # name of the testbench file
    tb_filename = 'tb_tes_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_tes_top_test_variant05.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_tes_top_test_variant06'
    # name of the testbench entity
    tb_name = 'tb_tes_top'
    # name of the testbench file
    tb_filename = 'tb_tes_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_tes_top_test_variant06.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_tes_top_test_variant07'
    # name of the testbench entity
    tb_name = 'tb_tes_top'
    # name of the testbench file
    tb_filename = 'tb_tes_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_tes_top_test_variant07.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_tes_top_test_variant08'
    # name of the testbench entity
    tb_name = 'tb_tes_top'
    # name of the testbench file
    tb_filename = 'tb_tes_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_tes_top_test_variant08.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_tes_top_test_variant09'
    # name of the testbench entity
    tb_name = 'tb_tes_top'
    # name of the testbench file
    tb_filename = 'tb_tes_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_tes_top_test_variant09.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_amp_squid_top'
    # name of the testbench entity
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_mux_squid_top'
    # name of the testbench entity
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_mux_squid_top_test_variant00'
    # name of the testbench entity
    tb_name = 'tb_mux_squid_top'
    # name of the testbench file
    tb_filename = 'tb_mux_squid_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_mux_squid_top_test_variant00.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_mux_squid_top_test_variant01'
    # name of the testbench entity
    tb_name = 'tb_mux_squid_top'
    # name of the testbench file
    tb_filename = 'tb_mux_squid_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_mux_squid_top_test_variant01.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_mux_squid_top_test_variant02'
    # name of the testbench entity
    tb_name = 'tb_mux_squid_top'
    # name of the testbench file
    tb_filename = 'tb_mux_squid_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_mux_squid_top_test_variant02.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_mux_squid_top_test_variant03'
    # name of the testbench entity
    tb_name = 'tb_mux_squid_top'
    # name of the testbench file
    tb_filename = 'tb_mux_squid_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_mux_squid_top_test_variant03.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_amp_squid_top_test_variant00'
    # name of the testbench entity
    tb_name = 'tb_amp_squid_top'
    # name of the testbench file
    tb_filename = 'tb_amp_squid_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_amp_squid_top_test_variant00.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_amp_squid_top_test_variant01'
    # name of the testbench entity
    tb_name = 'tb_amp_squid_top'
    # name of the testbench file
    tb_filename = 'tb_amp_squid_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_amp_squid_top_test_variant01.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_amp_squid_top_test_variant02'
    # name of the testbench entity
    tb_name = 'tb_amp_squid_top'
    # name of the testbench file
    tb_filename = 'tb_amp_squid_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_amp_squid_top_test_variant02.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    unit_test_description_list = [""]
    # name of the unitary test
    unit_test_name = 'tb_amp_squid_top_test_variant03'
    # name of the testbench entity
    tb_name = 'tb_amp_squid_top'
    # name of the testbench file
    tb_filename = 'tb_amp_squid_top.vhd'
    # list of test_variant_filename
    #  No filename <=> []
    test_variant_filename_list = ["tb_amp_squid_top_test_variant03.json"]
    # base path where to find the run_tb_XXXX script python
    run_basepath = str(Path(root_path, 'simu/vunit'))
    # filename of the run_XXXX python script
    run_filename = 'run_'+tb_name+'.py'
    ...
    json_test_dic["tb_tes_top_test_variant04"] = [solo_test_dic['tb_tes_top_test_variant04']]
    json_test_dic["tb_tes_top_test_variant05"] = [solo_test_dic['tb_tes_top_test_variant05']]
    json_test_dic["tb_tes_top_test_variant06"] = [solo_test_dic['tb_tes_top_test_variant06']]
    ...
    json_test_dic["tb_mux_squid_top_test_variant01"] = [solo_test_dic['tb_mux_squid_top_test_variant01']]
    json_test_dic["tb_mux_squid_top_test_variant02"] = [solo_test_dic['tb_mux_squid_top_test_variant02']]
    json_test_dic["tb_mux_squid_top_test_variant03"] = [solo_test_dic['tb_mux_squid_top_test_variant03']]
    ...
    json_test_dic["tb_amp_squid_top_test_variant01"] = [solo_test_dic['tb_amp_squid_top_test_variant01']]
    json_test_dic["tb_amp_squid_top_test_variant02"] = [solo_test_dic['tb_amp_squid_top_test_variant02']]
    json_test_dic["tb_amp_squid_top_test_variant03"] = [solo_test_dic['tb_amp_squid_top_test_variant03']]

    # spi_top
    json_test_dic["tb_spi_top_debug_test0"] = [solo_test_dic['tb_spi_top_conf_debug']]

    # variant00: tes_top, mux_squid_top, amp_squid_top, system_fpasim_top
    json_test_dic["tb_all_variant00"] = []
    json_test_dic["tb_all_variant00"].append(solo_test_dic['tb_tes_top_test_variant00'])
    json_test_dic["tb_all_variant00"].append(solo_test_dic['tb_mux_squid_top_test_variant00'])
    json_test_dic["tb_all_variant00"].append(solo_test_dic['tb_amp_squid_top_test_variant00'])
    json_test_dic["tb_all_variant00"].append(solo_test_dic['tb_system_fpasim_top_test_variant00'])
