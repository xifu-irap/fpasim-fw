...
if __name__ == '__main__':
    ...
    cli.parser.add_argument('--json_key_path', default='tb_amp_squid_top_test_variant00/tb_amp_squid_top',help=help0)
    ...
    #####################################################
    obj = AmpSquidTopDataGen( json_filepath_p =json_filepath, json_key_path_p = json_key_path)
