...
#    @file                   gen_random_mux_squid_files.py
# -------------------------------------------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    ###################################################
    # generate the mux_squid_offset
    ###################################################
    # output filename
    filename_out = 'random_mux_squid_offset.csv'
    # compute output filepath
    filepath_out = str(Path(base_address,filename_out))
    
    generate_random_int(output_filepath_p=filepath_out,ram_address_width_p=6,ram_data_width_p=16)

    ###################################################
    # generate the mux_squid_tf
    ###################################################
    # output filename
    filename_out = 'random_mux_squid_tf.csv'
    # compute output filepath
    filepath_out = str(Path(base_address,filename_out))
    generate_random_uint(output_filepath_p=filepath_out,ram_address_width_p=13,ram_data_width_p=16)
