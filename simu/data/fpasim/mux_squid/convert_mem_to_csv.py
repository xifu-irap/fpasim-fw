...
def convert_hex_to_int(input_filepath_p,output_filepath_p,ram_data_width_p=16):
    """
        This function convert hex string value into int value
    ...
    with open(output_filepath_p,'w') as fid:
        ...
        for index,str_line in enumerate(lines):
            ...
            if value >= 2**(ram_data_width_p-1):
                value = -(2**ram_data_width_p - value)
...
if __name__ == '__main__':
    ...
    input_filename_list = []
    input_filename_list.append('mux_squid_tf')
    ...
    # input file to search
    input_filename_list = []
    input_filename_list.append('mux_squid_offset')
    ...
    for filename in input_filename_list:
        ...
        convert_hex_to_int(input_filepath_p=input_filepath,output_filepath_p=output_filepath,ram_data_width_p=16)
