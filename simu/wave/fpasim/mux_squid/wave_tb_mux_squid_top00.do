...
add wave -noupdate -expand -group mux_squid_top -expand -group in /tb_mux_squid_top/dut_mux_squid_top/i_rst_status
add wave -noupdate -expand -group mux_squid_top -expand -group in /tb_mux_squid_top/dut_mux_squid_top/i_debug_pulse
add wave -noupdate -expand -group mux_squid_top -expand -group in /tb_mux_squid_top/i_inter_squid_gain
add wave -noupdate -expand -group mux_squid_top -expand -group in -group ram_mux_squid_offset /tb_mux_squid_top/dut_mux_squid_top/i_mux_squid_offset_wr_en
add wave -noupdate -expand -group mux_squid_top -expand -group in -group ram_mux_squid_offset -radix unsigned /tb_mux_squid_top/dut_mux_squid_top/i_mux_squid_offset_wr_rd_addr
add wave -noupdate -expand -group mux_squid_top -expand -group in -group ram_mux_squid_offset -radix unsigned /tb_mux_squid_top/dut_mux_squid_top/i_mux_squid_offset_wr_data
add wave -noupdate -expand -group mux_squid_top -expand -group in -group ram_mux_squid_offset /tb_mux_squid_top/dut_mux_squid_top/i_mux_squid_offset_rd_en
add wave -noupdate -expand -group mux_squid_top -expand -group in -group ram_mux_squid_offset /tb_mux_squid_top/dut_mux_squid_top/o_mux_squid_offset_rd_valid
add wave -noupdate -expand -group mux_squid_top -expand -group in -group ram_mux_squid_offset /tb_mux_squid_top/dut_mux_squid_top/o_mux_squid_offset_rd_data
add wave -noupdate -expand -group mux_squid_top -expand -group in -group ram_mux_squid_tf /tb_mux_squid_top/dut_mux_squid_top/i_mux_squid_tf_wr_en
add wave -noupdate -expand -group mux_squid_top -expand -group in -group ram_mux_squid_tf -radix unsigned /tb_mux_squid_top/dut_mux_squid_top/i_mux_squid_tf_wr_rd_addr
add wave -noupdate -expand -group mux_squid_top -expand -group in -group ram_mux_squid_tf /tb_mux_squid_top/dut_mux_squid_top/i_mux_squid_tf_wr_data
add wave -noupdate -expand -group mux_squid_top -expand -group in -group ram_mux_squid_tf /tb_mux_squid_top/dut_mux_squid_top/i_mux_squid_tf_rd_en
add wave -noupdate -expand -group mux_squid_top -expand -group in -group ram_mux_squid_tf /tb_mux_squid_top/dut_mux_squid_top/o_mux_squid_tf_rd_valid
add wave -noupdate -expand -group mux_squid_top -expand -group in -group ram_mux_squid_tf /tb_mux_squid_top/dut_mux_squid_top/o_mux_squid_tf_rd_data
add wave -noupdate -expand -group mux_squid_top -expand -group in -radix unsigned /tb_mux_squid_top/dut_mux_squid_top/i_mux_squid_feedback
add wave -noupdate -expand -group mux_squid_top -expand -group in -group data /tb_mux_squid_top/dut_mux_squid_top/i_pixel_sof
add wave -noupdate -expand -group mux_squid_top -expand -group in -group data /tb_mux_squid_top/dut_mux_squid_top/i_pixel_eof
add wave -noupdate -expand -group mux_squid_top -expand -group in -group data /tb_mux_squid_top/dut_mux_squid_top/i_pixel_valid
add wave -noupdate -expand -group mux_squid_top -expand -group in -group data -radix unsigned /tb_mux_squid_top/dut_mux_squid_top/i_pixel_id
add wave -noupdate -expand -group mux_squid_top -expand -group in -group data -radix unsigned /tb_mux_squid_top/dut_mux_squid_top/i_pixel_result
add wave -noupdate -expand -group mux_squid_top -expand -group in -group data /tb_mux_squid_top/dut_mux_squid_top/i_frame_sof
add wave -noupdate -expand -group mux_squid_top -expand -group in -group data /tb_mux_squid_top/dut_mux_squid_top/i_frame_eof
add wave -noupdate -expand -group mux_squid_top -expand -group in -group data -radix unsigned /tb_mux_squid_top/dut_mux_squid_top/i_frame_id
...
update
WaveRestoreZoom {181407772 ps} {181586972 ps}
