...
add wave -noupdate -group mux_squid -group in -group ram_mux_squid_offset -radix unsigned /tb_mux_squid_top/inst_mux_squid_top/i_mux_squid_offset_wr_data
...
add wave -noupdate -group mux_squid -group in -group ram_mux_squid_tf /tb_mux_squid_top/inst_mux_squid_top/i_mux_squid_tf_wr_data
...
add wave -noupdate -group mux_squid -group stepy -radix decimal /tb_mux_squid_top/inst_mux_squid_top/inst_mux_squid/mux_squid_offset_ry
add wave -noupdate -group mux_squid -group stepy -radix decimal /tb_mux_squid_top/inst_mux_squid_top/inst_mux_squid/mux_squid_tf_doutb
