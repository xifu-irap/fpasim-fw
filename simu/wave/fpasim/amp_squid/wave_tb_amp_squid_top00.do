...
add wave -noupdate -group amp_squid_top -group in -group ram_amp_squid_tf -format Analog-Step -height 74 -max 32764.000000000004 -min -32763.0 /tb_amp_squid_top/inst_amp_squid_top/i_amp_squid_tf_wr_data
...
add wave -noupdate -group amp_squid_top -group in -group data /tb_amp_squid_top/inst_amp_squid_top/i_pixel_sof
add wave -noupdate -group amp_squid_top -group in -group data /tb_amp_squid_top/inst_amp_squid_top/i_pixel_eof
add wave -noupdate -group amp_squid_top -group in -group data /tb_amp_squid_top/inst_amp_squid_top/i_pixel_valid
add wave -noupdate -group amp_squid_top -group in -group data -radix unsigned /tb_amp_squid_top/inst_amp_squid_top/i_pixel_id
add wave -noupdate -group amp_squid_top -group in -group data -radix unsigned /tb_amp_squid_top/inst_amp_squid_top/i_pixel_result
add wave -noupdate -group amp_squid_top -group in -group data /tb_amp_squid_top/inst_amp_squid_top/i_frame_sof
add wave -noupdate -group amp_squid_top -group in -group data /tb_amp_squid_top/inst_amp_squid_top/i_frame_eof
add wave -noupdate -group amp_squid_top -group in -group data -radix unsigned /tb_amp_squid_top/inst_amp_squid_top/i_frame_id
...
add wave -noupdate -group amp_squid_top -group stepy -format Analog-Step -height 74 -max 22919.0 -min -9848.0 -radix decimal /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/amp_squid_tf_doutb
...
add wave -noupdate -group amp_squid_top -group out -expand -group data /tb_amp_squid_top/inst_amp_squid_top/o_pixel_sof
add wave -noupdate -group amp_squid_top -group out -expand -group data /tb_amp_squid_top/inst_amp_squid_top/o_pixel_eof
add wave -noupdate -group amp_squid_top -group out -expand -group data /tb_amp_squid_top/inst_amp_squid_top/o_pixel_valid
add wave -noupdate -group amp_squid_top -group out -expand -group data -radix unsigned /tb_amp_squid_top/inst_amp_squid_top/o_pixel_id
add wave -noupdate -group amp_squid_top -group out -expand -group data -radix decimal /tb_amp_squid_top/inst_amp_squid_top/o_pixel_result
add wave -noupdate -group amp_squid_top -group out -expand -group data /tb_amp_squid_top/inst_amp_squid_top/o_frame_sof
add wave -noupdate -group amp_squid_top -group out -expand -group data /tb_amp_squid_top/inst_amp_squid_top/o_frame_eof
add wave -noupdate -group amp_squid_top -group out -expand -group data -radix unsigned /tb_amp_squid_top/inst_amp_squid_top/o_frame_id
...
WaveRestoreCursors {{Cursor 1} {581397371 ps} 0}
...
update
WaveRestoreZoom {0 ps} {911826313 ps}
