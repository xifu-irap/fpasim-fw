...
add wave -noupdate -group amp_squid_top -group in -radix unsigned /tb_amp_squid_top/inst_amp_squid_top/i_fpasim_gain
...
add wave -noupdate -group amp_squid_top -group stepy -radix sfixed -childformat {{/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain(5) -radix sfixed} {/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain(4) -radix sfixed} {/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain(3) -radix sfixed} {/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain(2) -radix sfixed} {/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain(1) -radix sfixed} {/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain(0) -radix sfixed}} -subitemconfig {/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain(5) {-height 15 -radix sfixed} /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain(4) {-height 15 -radix sfixed} /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain(3) {-height 15 -radix sfixed} /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain(2) {-height 15 -radix sfixed} /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain(1) {-height 15 -radix sfixed} /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain(0) {-height 15 -radix sfixed}} /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/fpasim_gain
...
add wave -noupdate -group amp_squid_fpagain_table -group generic /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/g_Q_M_S
add wave -noupdate -group amp_squid_fpagain_table -group generic /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/g_Q_N_S
add wave -noupdate -group amp_squid_fpagain_table -group generic /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/g_LATENCY_OUT
add wave -noupdate -group amp_squid_fpagain_table -group in /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/i_clk
add wave -noupdate -group amp_squid_fpagain_table -group in /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/i_fpasim_gain
add wave -noupdate -group amp_squid_fpagain_table -group in /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/i_pixel_sof
add wave -noupdate -group amp_squid_fpagain_table -group in /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/i_pixel_valid
add wave -noupdate -group amp_squid_fpagain_table -group step1 -radix sfixed /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_r1
add wave -noupdate -group amp_squid_fpagain_table -group step1 -radix unsigned -childformat {{/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0(5) -radix unsigned} {/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0(4) -radix unsigned} {/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0(3) -radix unsigned} {/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0(2) -radix unsigned} {/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0(1) -radix unsigned} {/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0(0) -radix unsigned}} -subitemconfig {/tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0(5) {-height 15 -radix unsigned} /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0(4) {-height 15 -radix unsigned} /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0(3) {-height 15 -radix unsigned} /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0(2) {-height 15 -radix unsigned} /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0(1) {-height 15 -radix unsigned} /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0(0) {-height 15 -radix unsigned}} /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp0
add wave -noupdate -group amp_squid_fpagain_table -group step2 /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/gain_tmp1
add wave -noupdate -group amp_squid_fpagain_table -expand -group out /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_amp_squid_fpagain_table/o_fpasim_gain
add wave -noupdate -group mult_sfixed_amp_squid_correction -group amp_squid_tf_out -radix sfixed /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_mult_sfixed_amp_squid_correction_and_tf/a_r1
add wave -noupdate -group mult_sfixed_amp_squid_correction -group fpagain -radix sfixed /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_mult_sfixed_amp_squid_correction_and_tf/b_r1
add wave -noupdate -group mult_sfixed_amp_squid_correction -divider full_out
add wave -noupdate -group mult_sfixed_amp_squid_correction -radix sfixed /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_mult_sfixed_amp_squid_correction_and_tf/p_r4
add wave -noupdate -group mult_sfixed_amp_squid_correction -divider trunc_out
add wave -noupdate -group mult_sfixed_amp_squid_correction -radix sfixed /tb_amp_squid_top/inst_amp_squid_top/inst_amp_squid/inst_mult_sfixed_amp_squid_correction_and_tf/p_tmp5
