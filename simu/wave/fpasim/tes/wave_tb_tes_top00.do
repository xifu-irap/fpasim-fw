...
add wave -noupdate -group tes_pulse_manager -group in /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_clk
add wave -noupdate -group tes_pulse_manager -group in /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_rst
add wave -noupdate -group tes_pulse_manager -group in /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_rst_status
add wave -noupdate -group tes_pulse_manager -group in /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_debug_pulse
add wave -noupdate -group tes_pulse_manager -group in -group cmd /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_cmd_valid
add wave -noupdate -group tes_pulse_manager -group in -group cmd -radix unsigned /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_cmd_pulse_height
...
add wave -noupdate -group tes_pulse_manager -group in -group cmd -radix unsigned /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_cmd_time_shift
add wave -noupdate -group tes_pulse_manager -group in -group ram_pulse_shape /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_pulse_shape_wr_en
add wave -noupdate -group tes_pulse_manager -group in -group ram_pulse_shape -radix unsigned /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_pulse_shape_wr_rd_addr
add wave -noupdate -group tes_pulse_manager -group in -group ram_pulse_shape /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_pulse_shape_wr_data
add wave -noupdate -group tes_pulse_manager -group in -group ram_pulse_shape /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_pulse_shape_rd_en
add wave -noupdate -group tes_pulse_manager -group in -group ram_pulse_shape /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/o_pulse_shape_rd_valid
add wave -noupdate -group tes_pulse_manager -group in -group ram_pulse_shape /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/o_pulse_shape_rd_data
add wave -noupdate -group tes_pulse_manager -group in -group ram_steady_state /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_steady_state_wr_en
add wave -noupdate -group tes_pulse_manager -group in -group ram_steady_state -radix unsigned /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_steady_state_wr_rd_addr
add wave -noupdate -group tes_pulse_manager -group in -group ram_steady_state /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_steady_state_wr_data
add wave -noupdate -group tes_pulse_manager -group in -group ram_steady_state /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_steady_state_rd_en
add wave -noupdate -group tes_pulse_manager -group in -group ram_steady_state /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/o_steady_state_rd_valid
add wave -noupdate -group tes_pulse_manager -group in -group ram_steady_state /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/o_steady_state_rd_data
add wave -noupdate -group tes_pulse_manager -group in -expand -group data /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_pixel_sof
add wave -noupdate -group tes_pulse_manager -group in -expand -group data /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_pixel_eof
add wave -noupdate -group tes_pulse_manager -group in -expand -group data -radix unsigned /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_pixel_id
add wave -noupdate -group tes_pulse_manager -group in -expand -group data /tb_tes_top/inst_dut_tes_top/inst_tes_pulse_shape_manager/i_pixel_valid
