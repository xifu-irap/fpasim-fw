...
add wave -noupdate -group regdecode_top -group usb -group out /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_usb_wireout_fifo_data_count
...
add wave -noupdate -group regdecode_top -group reg -expand -group make_pulse /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_reg_make_sof
add wave -noupdate -group regdecode_top -group reg -expand -group make_pulse /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_reg_make_eof
add wave -noupdate -group regdecode_top -group reg -expand -group make_pulse /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_reg_make_pulse_valid
add wave -noupdate -group regdecode_top -group reg -expand -group make_pulse /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_reg_make_pulse
...
add wave -noupdate -group regdecode_top -group ram_tes_steady_state -group wr /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_tes_std_state_ram_wr_en
add wave -noupdate -group regdecode_top -group ram_tes_steady_state -group wr -radix unsigned /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_tes_std_state_ram_wr_rd_addr
add wave -noupdate -group regdecode_top -group ram_tes_steady_state -group wr /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_tes_std_state_ram_wr_data
add wave -noupdate -group regdecode_top -group ram_tes_steady_state -group rd /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_tes_std_state_ram_rd_en
add wave -noupdate -group regdecode_top -group ram_tes_steady_state -group rd /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/i_tes_std_state_ram_rd_valid
add wave -noupdate -group regdecode_top -group ram_tes_steady_state -group rd /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/i_tes_std_state_ram_rd_data
add wave -noupdate -group regdecode_top -group ram_mux_squid_offset -group wr /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_mux_squid_offset_ram_wr_en
add wave -noupdate -group regdecode_top -group ram_mux_squid_offset -group wr -radix unsigned /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_mux_squid_offset_ram_wr_rd_addr
add wave -noupdate -group regdecode_top -group ram_mux_squid_offset -group wr /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_mux_squid_offset_ram_wr_data
...
add wave -noupdate -group regdecode_top -group ram_amp_squid_tf -group wr -radix unsigned /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_amp_squid_tf_ram_wr_rd_addr
...
add wave -noupdate -group regdecode_top -group ram_amp_squid_tf -group rd /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/o_amp_squid_tf_ram_rd_en
add wave -noupdate -group regdecode_top -group ram_amp_squid_tf -group rd /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/i_amp_squid_tf_ram_rd_valid
add wave -noupdate -group regdecode_top -group ram_amp_squid_tf -group rd /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/i_amp_squid_tf_ram_rd_data
...
add wave -noupdate /tb_system_fpasim_top/o_opal_kelly_type
add wave -noupdate /tb_system_fpasim_top/o_opal_kelly_addr
add wave -noupdate /tb_system_fpasim_top/o_data
add wave -noupdate /tb_system_fpasim_top/o_data_valid
add wave -noupdate -expand -group wire_make_pulse -group in /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/i_rst_status
add wave -noupdate -expand -group wire_make_pulse -group in /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/i_debug_pulse
add wave -noupdate -expand -group wire_make_pulse -group in /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/i_out_clk
add wave -noupdate -expand -group wire_make_pulse -group in -expand -group cmd /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/i_make_pulse_valid
add wave -noupdate -expand -group wire_make_pulse -group in -expand -group cmd -radix unsigned /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/i_pixel_nb
add wave -noupdate -expand -group wire_make_pulse -group in -expand -group cmd /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/i_make_pulse
add wave -noupdate -expand -group wire_make_pulse -expand -group step1 /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/sm_state_r1
add wave -noupdate -expand -group wire_make_pulse -expand -group step1 /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/sof_r1
add wave -noupdate -expand -group wire_make_pulse -expand -group step1 /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/eof_r1
add wave -noupdate -expand -group wire_make_pulse -expand -group step1 /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/data_valid_r1
add wave -noupdate -expand -group wire_make_pulse -expand -group step1 /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/error_r1
add wave -noupdate -expand -group wire_make_pulse -expand -group step1 -radix unsigned /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/pixel_id_r1
add wave -noupdate -expand -group wire_make_pulse -expand -group step1 /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/pixel_id_max_r1
add wave -noupdate -expand -group wire_make_pulse -expand -group step1 /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/data_r1
add wave -noupdate -expand -group wire_make_pulse -group out -group to_user /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/o_sof
add wave -noupdate -expand -group wire_make_pulse -group out -group to_user /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/o_eof
add wave -noupdate -expand -group wire_make_pulse -group out -group to_user /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/o_data_valid
add wave -noupdate -expand -group wire_make_pulse -group out -group to_user /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/o_data
add wave -noupdate -expand -group wire_make_pulse -group out -group to_usb /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/i_fifo_rd
add wave -noupdate -expand -group wire_make_pulse -group out -group to_usb /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/o_fifo_data_valid
add wave -noupdate -expand -group wire_make_pulse -group out -group to_usb /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/o_fifo_sof
add wave -noupdate -expand -group wire_make_pulse -group out -group to_usb /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/o_fifo_eof
add wave -noupdate -expand -group wire_make_pulse -group out -group to_usb /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/o_fifo_data
add wave -noupdate -expand -group wire_make_pulse -group out -group to_usb /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/o_fifo_empty
add wave -noupdate -expand -group wire_make_pulse -group out -color Magenta -itemcolor Red /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/o_errors
add wave -noupdate -expand -group wire_make_pulse -group out /tb_system_fpasim_top/dut_top_fpasim_system/inst_top_fpasim/inst_regdecode_top/inst_regdecode_wire_make_pulse/o_status
...
WaveRestoreCursors {{Cursor 1} {7738804 ps} 0}
...
update
WaveRestoreZoom {7695851 ps} {7781757 ps}
